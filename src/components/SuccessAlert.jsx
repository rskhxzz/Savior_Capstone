export default function SuccessAlert(show, setShow) {
    // If show is false, return null (nothing to render)
    if (!show) {
        return null;
    }
    ...
    return (
        <div 
            ...
            tabIndex={30} 
            aria-hidden="true" 
            className={`${show ? 'fixed' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full`}
        >
